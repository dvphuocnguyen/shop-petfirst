    ...
    return (
        <div className={cx('contact')}>
            <div className={cx('contactInfo')}>
                ...
                <div className={cx('contactInfoItem')}>
                    ...
                    <div className={cx('contact-ss')}>
                        ...
                        <p>62/4 Trần Bình Trọng, Phường 8, TP. Vũng Tàu</p>
                    </div>
                </div>
                <div className={cx('contactInfoItem')}>
            ...
            <div className={cx('contactForm')}>
                ...
                <p>Bạn có câu hỏi, nhận xét hoặc ý tưởng tuyệt vời muốn chia sẻ? Gửi cho chúng tôi một ghi chú nhỏ bên dưới - chúng tôi muốn nghe ý kiến của bạn và sẽ luôn trả lời!</p>
